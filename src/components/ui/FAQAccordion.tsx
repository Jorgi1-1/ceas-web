...
const faqs: FAQItem[] = [
  ...
  { question: "¿Puedo cambiar de programa si comienzo?", answer: "Sí puedes cambiar a otro curso, pero probablemente tengas que iniciar desde que comienza el nuevo curso debiendo cubrir las colegiaturas que correspondan al nuevo programa que elijas.", category: "general" },
  // DURACION
  { question: "¿Puedo estudiar a mi ritmo?", answer: "Las clases son presenciales y un día a la semana en un horario establecido, por lo que se recomienda que el resto de los días en la semana repases lo visto en clase presencial.", category: "duracion" },
  // INVERSION
  ...
  // EMPLEABILIDAD
  { question: "¿Qué oportunidades laborales tengo al egresar?", answer: "Puedes laborar principalmente de manera independiente estableciendo tu propio centro de terapias manuales naturales, también puedes trabajar en centros deportivos, equipos deportivos, o como auxiliar en algunas clínicas de terapia física, así como establecer convenios con médicos que requieran referir a sus pacientes para alguna terapia de recuperación.", category: "empleabilidad" },
  // CERTIFICADO
  { question: "¿Es válido el certificado a nivel nacional?", answer: "Nuestros cursos de Habilitación física funcional y de Terapeuta SPA \"Aplicación de aceites esenciales con técnicas de masaje\" son reconocidos por SEP, por lo que el certificado obtenido sí es válido a nivel nacional.", category: "certificado" },
  { question: "¿El diploma es avalado por SEP?", answer: "Nuestros cursos de Habilitación física funcional y de Terapeuta SPA \"Aplicación de aceites esenciales con técnicas de masaje\" son avalados por SEP. Otros cursos pueden estar avalados por la Federación mundial de masaje (WMF) o por CONOCER-SEP.", category: "certificado" },
  // OTROS
